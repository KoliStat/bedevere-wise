...
async function initApplication() {
  ...
  // DuckDB init or app chrome. Stripped from release branches before
  // shipping (this file + perf-harness.ts + SyntheticDataProvider.ts).
  ...
  const appVersion = "0.9-king-of-the-britons";
